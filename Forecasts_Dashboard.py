...
st.markdown("This dashboard compares forecasting models for Amazon, Apple, Tesla, Microsoft and Boeing using stock prices and twitter sentiment. Use the filters below to explore predictions across models and time horizons.")
...
st.info("Lower RMSE indicates better predictive performance.")
